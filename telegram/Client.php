...
use system\lib\telegram\Events\EventCollection;
...
class Client
{
    ...
    /**
     * @var \system\lib\telegram\Telegram
     */
    protected $api;

    /**
     * @var \system\lib\telegram\Events\EventCollection
     */
    protected $events;
     ...
     *
     * @return \system\lib\telegram\Client
     */
    ...
    public function handle(array $updates)
    {
        foreach ($updates as $update) {
            /* @var \system\lib\telegram\Types\Update $update */
    ...
    public function run()
    {
        if ($data = Telegram::jsonValidate( $this->getRawBody(), true)) {
